...
from scripts.utility import get_directory_path, get_non_existing_directory_path
import os

pedigree_directory = get_directory_path("Specify the testing directory:")
os.chdir(pedigree_directory)
result_dir_name = get_non_existing_directory_path("Specify the name of the directory containing the result:")
